    ...
    <v-row class="align-center ma-0 justify-space-between">
      ...
      <v-col class="d-none d-md-flex order-md-2">
        <v-row class="justify-md-end flex-nowrap">
            <v-btn to="/goods" variant="outlined" prepend-icon="mdi-information-outline" class="v-btn-add">Info</v-btn>
            <v-btn to="/goods" variant="outlined" prepend-icon="mdi-new-box" class="v-btn-add">News</v-btn>
