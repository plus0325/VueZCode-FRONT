<template>
  ...
  <div class="d-md-none" id="menu-btn">
    <v-btn
      :icon= "data.showMenu ? 'mdi-close' : 'mdi-menu'"
      height="100%"
      width="100%"
      id="mdi-icon"
      @click="data.showMenu = true"
    ></v-btn>
    ...
    <!-- <v-icon @click="dialog = true" size="80">mdi-menu</v-icon> -->
      ...
      <v-menu transition="scroll-y-reverse-transition" v-model="data.showMenu">
